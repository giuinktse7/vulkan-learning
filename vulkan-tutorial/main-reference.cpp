...
private:
	...
	void createTextureImage()
	{
		...
		stbi_uc *pixels = stbi_load("textures/cat.jpg",
																&width,
																&height,
																&channels,
																STBI_rgb_alpha);
...
void test()
{
	...
	auto crossbowTexture = engine.CreateTexture("textures/crossbow.png");
	auto plateArmorTexture = engine.CreateTexture("textures/plate.png");
